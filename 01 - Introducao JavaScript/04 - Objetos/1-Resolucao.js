...
let filmeExists = false;

for (let i = 0; i < reader.favoriteBooks.length; i += 1) {
    if (reader.favoriteBooks[i].title === "Harry Potter e o Prisioneiro de Azkaban") {
        filmeExists = true;
    }

    if (filmeExists === false) {
...
console.log(`${reader.name} tem ${reader.favoriteBooks.length} liros favoritos`);
